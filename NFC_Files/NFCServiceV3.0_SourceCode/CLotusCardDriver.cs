...

{
    ...
    public class CLotusCardDriver
    {
        ...
        public static extern long LotusCardOpenDevice(string pszDeviceName, int nVID, int nPID, int nUsbDeviceIndex, uint unRecvTimeOut, OnLotusCardExtendReadWriteCallBackFunc CallBackFunc);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardCloseDevice", SetLastError = true,
             ...
             CallingConvention = CallingConvention.StdCall)]
        public static extern void LotusCardCloseDevice(long nDeviceHandle);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardBeep", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardBeep(long nDeviceHandle, int nBeepLen);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardRequest", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardRequest( long nDeviceHandle,int nRequestType, ref LotusCardParamStruct sttLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardAnticoll", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardAnticoll(long nDeviceHandle, ref LotusCardParamStruct sttLotusCardParam);
		...
		*/
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardResetCpuCard", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardResetCpuCard(long nDeviceHandle,
        ref LotusCardParamStruct sttLotusCardParam);
        ...
        [DllImport("LotusCardDriver.dll", EntryPoint = "LotusCardSendCOSCommand", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        public static extern int LotusCardSendCOSCommand(long nDeviceHandle,
        ref LotusCardParamStruct sttLotusCardParam);
		...
		*/
         ...
         *            设备句柄
         */
        public void CloseDevice(long nDeviceHandle)
        {
            if (-1 != nDeviceHandle)
            {
         ...
         * @return true = 成功
         */
        public static int Request( long  nDeviceHandle,  int nRequestType,
               ref LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int Anticoll(long nDeviceHandle,
                ref LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int Beep(long nDeviceHandle, int nBeepLen)
        {
         ...
         * @return true = 成功
         */
        public int ResetCpuCard(long nDeviceHandle, ref LotusCardParamStruct sttLotusCardParam)
        {
         ...
         * @return true = 成功
         */
        public int SendCOSCommand(long nDeviceHandle, ref LotusCardParamStruct sttLotusCardParam)
        {
